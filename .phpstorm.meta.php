...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\ROG\.config\valet\Sites\siap-pak\public\storage' => 'string',
            ...
            'services.fonnte.token' => 'string',
            'services.fonnte.admin_phone' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\ROG\\.config\\valet\\Sites\\siap-pak\\public\\storage','logging.default','logging.deprecations.channel',
...
'services.fonnte.token','services.fonnte.admin_phone','session.driver','session.lifetime','session.expire_on_close',
...
'profile.update','profile.destroy','reports.index','reports.show','reports.store',
'notifications.read','notifications.markRead','equipments.index','equipments.show','users.index',
'users.store','users.update','users.destroy','reports.progress.update','equipments.store',
'equipments.update','equipments.destroy','equipments.trashed','equipments.restore','equipments.forceDelete',
'calibrations.store','calibrations.destroy','rooms.index','rooms.store','rooms.update',
'rooms.destroy','calibrations.index','equipments.move','login',
...
'C:.Users.ROG..config.valet.Sites.siap-pak.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','FONNTE_TOKEN','FONNTE_ADMIN_PHONE',);
