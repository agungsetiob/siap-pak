...
const RichTextEditor = ({
    ...
    // Sinkronkan ketika value dari parent berubah
    useEffect(() => {
        if (!editor) return;
                ...
                >
                    ...
                    >
                        <path
                            ...
                            strokeLinejoin="round"
                            strokeWidth="2"
                            d="M4 6v12M8 6v12M4 12h4M12 6v12M16 6v12M12 12h4"
                        />
                    </svg>
                </button>
                ...
                >
                    ...
                    >
                        <path
                            ...
                            strokeLinejoin="round"
                            strokeWidth="2"
                            d="M4 6h16M4 12h16M4 18h16M4 6h.01M4 12h.01M4 18h.01"
                        />
                    </svg>
                </button>
                <button
                ...
                >
                    ...
                    >
                        <path
                            ...
                            strokeLinejoin="round"
                            strokeWidth="2"
                            d="M7 4v16M17 4v16M7 12h10M7 8h10M7 16h10M3 6h2M3 12h2M3 18h2"
                        />
                    </svg>
                </button>
                ...
                {editor?.isActive("table") && (
                    <div className="flex bg-blue-50 rounded-lg p-0.5 border border-blue-100 ml-1">
                        ...
                        <button
                            ...
                            className="p-1 text-red-600 hover:bg-red-200 rounded ml-1"
                            title="Hapus Tabel"
                        >
                            <svg
                                className="w-3 h-3"
...
export default function Show({ auth, report, flash }) {
    ...
    const isSelesai =
        report.status === "selesai" || report.status === "dibatalkan";
    ...
    const displayLogs = showAllLogs
        ? report.progress_logs
        : report.progress_logs?.slice(0, 3);
        ...
        <AuthenticatedLayout user={auth.user} header={null}>
            ...
            <div className="py-2">
                <div className="max-w-8xl mx-auto sm:px-4 lg:px-4 mb-6">
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-white rounded-2xl shadow-sm border border-gray-200 p-4 sm:p-6 print:hidden">
                            ...
                            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl border border-blue-100 shadow-sm overflow-hidden">
                                ...
                                >
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            <InputLabel
                                                htmlFor="external_technician"
                                                value="Teknisi / Vendor Luar"
                                                className="text-sm font-semibold"
                                            />
                                ...
                                <div className="p-6 space-y-3">
                                    <div
                                        dangerouslySetInnerHTML={{
                                            __html: report.action_taken,
                                        }}
                                        className="text-sm text-gray-700 prose prose-sm prose-green max-w-none"
                                    />
                                        ...
                                        <div className="min-h-[80px] flex items-center justify-center">
                                            {report.room_approved_at ? (
                                                report.reporter
                                                    ?.signature_path ? (
                                                    <img
                                                        src={`/storage/${report.reporter.signature_path}`}
                                                        alt="TTD Pelapor"
                                            ...
                                            {report.status === "selesai" ? (
                                                (() => {
                                                    ...
                                                    if (
                                                        ...
                                                        return (
                                                            <img
                                                                src={`/storage/${selesaiLog.user.signature_path}`}
                                                                alt="TTD Admin"
                                                                className="max-h-16 object-contain mix-blend-multiply"
                                                            />
                                                        );
                            ...
                            <div className="px-6 py-4 bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200 flex items-center justify-between">
                                ...
                                {report.progress_logs?.length > 3 && (
                                    ...
                                    >
                                        {showAllLogs
                                            ? "Sembunyikan"
                                            : `Lihat Semua (${report.progress_logs.length})`}
                                    </button>
                                )}
                            </div>
                            <div className="p-6">
                                <div className="relative border-l-2 border-gray-200 ml-3 space-y-8">
                                    {displayLogs?.map((log) => (
                                        ...
                                        >
                                            <span
                                                className={`absolute -left-[9px] top-1.5 h-4 w-4 rounded-full border-2 border-white shadow-sm
                                                ${
                                                    log.status_snapshot ===
                                                    "menunggu"
                                                        ? "bg-red-500"
