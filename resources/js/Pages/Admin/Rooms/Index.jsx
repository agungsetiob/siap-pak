...
import { Modal, TextInput, InputLabel, DeleteModal,
    PrimaryButton, SecondaryButton, FlashMessage, InputError
 } from '@/Components';
    ...
    return (
        ...
        >
            ...
            <DeleteModal
                ...
                message="Apakah Anda yakin ingin menghapus data ruangan ini?"
            />
        </AuthenticatedLayout>
    );
}